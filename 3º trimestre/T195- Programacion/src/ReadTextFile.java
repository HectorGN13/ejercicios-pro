...
public class ReadTextFile {
   ...
   /* public static void openFile() {
        ...
        try {
            input = new Scanner(Paths.get("src/clientes.txt"));
    ...
    private static void readRecords() {
        ...
        try ( Scanner input = new Scanner(Paths.get("src/clientes.txt"))) {
    ...
    // Try con recurso se encarga de cerrar el escaner (Scanner implemnta AutoCloseable)
